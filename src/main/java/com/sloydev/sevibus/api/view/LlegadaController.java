...
public class LlegadaController {
    ...
    @RequestMapping("/llegada/{parada}/{lineas}")
    public List<ArrivalTimes> llegadas(@PathVariable(value = "lineas") String[] lineas, @PathVariable(value = "parada") Integer parada) {
